...
export const AddressForm = ({ onTabSwitch }) => {
    ...
    return (
        <form className="px-3 pt-1 md:w-2/3 md:mx-auto" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mb-4">
                ...
                <input 
                    ...
                    className="w-full px-3 py-2 mb-3 text-sm leading-tight text-gray-700 border shadow appearance-none rounded focus:outline-none focus:shadow-outline"
                    id="street address"
                    type="text"
            ...
            <div className="mb-4 md:flex md:justify-between">
                <div className="flex-1 mb-4 md:mr-2 md:mb-0">
